  ...
  return (
    ...
    >
      <header className="mb-8 flex items-center gap-3">
        ...
        <h1 className="font-display text-4xl text-text">Stats</h1>
      </header>
      ...
      <div className="flex flex-col gap-6">
        ...
        <ChartCard
          title="Mastery map"
          description="Easiness factor per country — red needs work, green is mastered."
        >
          <MasteryHeatmap />
        </ChartCard>
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          <ChartCard
            title="Progression"
            description="Daily accuracy over the last 30 days."
          >
            <ProgressionChart />
          </ChartCard>
          <ChartCard
            title="Forgetting curve"
            description="Recall rate vs. days since last review."
          >
            <ForgettingCurve />
          </ChartCard>
        </div>
        ...
        <ChartCard
          title="Continent mastery"
          description="Share of cards mastered in each continent."
        >
          <ContinentRadar />
        </ChartCard>
      </div>
